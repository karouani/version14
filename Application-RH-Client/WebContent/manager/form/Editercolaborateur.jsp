									...
									<div class="span12">
										<div class="row-fluid">
											<label class="form-label span3" for="fname">Matricule
												...
												type="text" required="required" value="<s:property value='model.getMatricule()'/>" maxlength="5" />
										</div>
									</div>
								</div>
									...
									<div class="span12">
										<div class="row-fluid" id="diplome">
											<label class="form-label span3" for="diplome" >Diplôme
												:</label> <input class="span9" type="text" required="required" name="ecole" />
										...
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span3" for="abreviation">date
													...
													name="datedepart" type="text" required="required" />
											</div>
										</div>
									</div>
								</s:if>
									...
									<div class="span12">
										<div class="row-fluid">
											<label class="form-label span3" for="salaireactuel">Salaire
												...
												name="salaireactuel" type="text" required="required" disabled="disabled" />
										</div>
									</div>
								</div>
									...
									<div class="span12">
										<div class="row-fluid"  id="technologie">
											...
											<div class="span7 controls" id="techno"
												style="display: -webkit-box; display: -moz-box; display: -webkit-flexbox; display: -ms-flexbox; display: -webkit-flex; display: flex; width: 74%; margin-top: 8px;">
												<input class="span6 text" type="text" required="required" name="desctechno"
