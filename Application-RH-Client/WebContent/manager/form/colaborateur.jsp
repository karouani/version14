	...
	<div class="span12">
		<div class="box gradient">
			...
			<div class="content noPad clearfix">
				...
				<form action="AjouterCollaborateur" method="POST"
					class="form-horizontal" id="wizzard-form">
					<!-- Smart Wizard -->
					<s:if test="gmail == null">
						<h1>Il faut Renseigner les donnes de Gmail Obligatoirement</h1>

						<div class="form-row row-fluid">
							<div class="span12">
								<div class="row-fluid">
									<label class="form-label span3" for="emailGmail">Login Gmail
										:</label> <input class="span9" type="email" name="emailGmail">
								</div>
							</div>
						</div>
						...
						<div class="form-row row-fluid">
							<div class="span12">
								<div class="row-fluid">
									<label class="form-label span3" for="pass">Password Gmail :
										:</label>
										<input type="password" class="span9" name="pass">
								</div>
							</div>
						</div>
					...
					<s:else>
						<input type="email" name="emailGmail"
							value='<s:property value="gmail"/>'>
						<br />
						<input type="password" name="pass"
							value='<s:property value="passwordGmail"/>'>
						<br />
					</s:else>
									...
									<div class="span12">
										<div class="row-fluid" id="diplome">
											<label class="form-label span3" for="diplome">Diplôme
												1 :</label> <input class="span9 ecole" type="text"
												required="required" name="ecole" />
											<div class="span7 controls"
												...
												</select> <input type="text" required="required" name="promotion"
									...
									<div class="span12">
										<div class="row-fluid">
											<label class="form-label span3" for="dateembauche">Date
												Embauche</label> <input type="text" required="required"
												class="span9" id="datepicker" name="dateembauche" />
										</div>
									</div>
								</div>
										...
										<div class="row-fluid" id="technologie">
											...
											<div class="span7 controls" id="techno"
												...
												<input class="span6 text desctechno" type="text"
													required="required" name="desctechno"
													placeholder="Technologie" /> <input
													class="span6 text comp" type="text" required="required"
													name="comp" placeholder="Comp&eacute;tences" /> <select
													class="level" name="level" style="width: 0;">
