...
public class StrinCreerExcel {
	...
	public StrinCreerExcel(Map< String, String[]> dat,String[] tit,String nom,String flnom , int x){
		...
		this.filenome=flnom;
		this.x = x;
		this.nomFichier = createCicin(x);

		System.out.println("Le chemain du fichier est "+cheminFichier);
	}

	public StrinCreerExcel() {
		super();
	}
	...
	public String createCicin(int x){
		String file = null;
		try {
			...
			System.out.println("voile tmp "+url);
