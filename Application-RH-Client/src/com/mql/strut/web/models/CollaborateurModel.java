...
public class CollaborateurModel {
	...
	public CollaborateurModel(int matricule, String nom, String prenom,
	...
	public CollaborateurModel(List<String> ecole, List<String> niveau,
	...
	public Double getSalaireactuel() {
		return Double.parseDouble(salaireactuel);
	}
