...
@Entity
@DiscriminatorValue("ManagerAgence")
public class ManagerAgence extends Collaborateurs {

	public ManagerAgence(int matricule, String nom, String prenom,
